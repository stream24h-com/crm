<template>
  <div>
    <a-page-header
      ...
      class="task-header"
    />
    <div class="task-page" :style="{ margin: '24px' }">
<!--      <a-row class="general-row" :gutter="25" :style="{ marginBottom: '24px' }">
        <a-col :span="6">
          <a-badge-ribbon color="red">
            <a-card :bordered="false" title="Tổng tài sản">
              <h2 :style="{ textAlign: 'center', fontSize: '2rem' }">50</h2>
            </a-card>
          </a-badge-ribbon>
        </a-col>
        <a-col :span="6">
          <a-badge-ribbon color="green">
            <a-card :bordered="false" title="Tài sản Xe 4 bánh">
              <h2 :style="{ textAlign: 'center', fontSize: '2rem' }">22</h2>
            </a-card>
          </a-badge-ribbon>
        </a-col>
        <a-col :span="6">
          <a-badge-ribbon color="grey">
            <a-card :bordered="false" title="Tài sản Đồ điện tử">
              <h2 :style="{ textAlign: 'center', fontSize: '2rem' }">12</h2>
            </a-card>
          </a-badge-ribbon>
        </a-col>
        <a-col :span="6">
          <a-badge-ribbon color="pink">
            <a-card :bordered="false" title="Tài sản khác">
              <h2 :style="{ textAlign: 'center', fontSize: '2rem' }">18</h2>
            </a-card>
          </a-badge-ribbon>
        </a-col>
      </a-row>-->
      <a-row class="letter-row" :gutter="25">
        <a-col :span="24" style="">
          <a-card :bordered="false" title="Danh sách công việc">
            <div>
              <SearchTable
                  linkCreate="/erp/task/create/"
                  linkUpdate="/erp/task"
              ...
              >
                <template v-slot:button-first="ganttChart">
                  <a-button type="primary" @click="showModalGantt">
                    <TableOutlined />
                    Sơ đồ Gantt
                  </a-button>
                  <a-modal
  ...
  "data": [
    {
      ...
      "taskKeeper": 'Thanh Tâm, Phương Quý',
      "timeline": '15-02-2023 02:02',
      "timeline1": '23-02-2023 18:26',
      "taskStatus": 'Open',
    },
    {
      "key": 2,
      "taskName": 'Công việc 2',
      "taskKeeper": 'Ngọc Hải, Như Huyền',
      "timeline": '15-02-2023 02:02',
      "timeline1": '23-02-2023 18:26',
      "taskStatus": 'Pending',
    },
    {
      ...
      "taskKeeper": 'Minh Nguyên, Hoàng Thông',
      "timeline": '15-02-2023 02:02',
      "timeline1": '23-02-2023 18:26',
    ...
    },
    {
      ...
      "timeline": '15-02-2023 02:02',
      "timeline1": '23-02-2023 18:26',
      "taskStatus": 'Done local',
    },
    {
      "key": 6,
      "taskName": 'Công việc 6',
      "taskKeeper": 'Minh Nguyên, Hoàng Thông',
      "timeline": '15-02-2023 02:02',
      "timeline1": '23-02-2023 18:26',
      "taskStatus": 'Reviewed',
